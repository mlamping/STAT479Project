...
ggplot(health, aes(x = extent, y= reorder(question_text, extent, mean))) +
  geom_violin() +
...
ggplot(outinfluences, aes(x = extent, y= reorder(question_text, extent, mean))) +
  geom_violin() +
...
ggplot(society, aes(x = extent, y= reorder(question_text, extent, mean))) +
  geom_violin() +
...
ggplot(financial, aes(x = extent, y= reorder(question_text, extent, mean))) +
  geom_violin() +
